    ...
    pub fn builtin() -> Self {
        ...
        attributes.insert(
            ...
            NarrativeAttributeConfig {
                ...
                thresholds: vec![
                    ...
                    NarrativeThreshold { min: 20, max: 39, description: "肚子很饿，饥肠辘辘".to_string() },
        ...
        attributes.insert(
            ...
            NarrativeAttributeConfig {
                ...
                thresholds: vec![
                    NarrativeThreshold { min: 80, max: 100, description: "完全不渴".to_string() },
                    NarrativeThreshold { min: 60, max: 79, description: "略有口渴".to_string() },
                    NarrativeThreshold { min: 40, max: 59, description: "口渴明显".to_string() },
                    NarrativeThreshold { min: 20, max: 39, description: "非常口渴".to_string() },
                    NarrativeThreshold { min: 0, max: 19, description: "渴得难以忍受".to_string() },
                ],
        ...
        attributes.insert(
            ...
            NarrativeAttributeConfig {
                ...
                thresholds: vec![
                    NarrativeThreshold { min: 80, max: 100, description: "体力充沛，精力旺盛".to_string() },
                    NarrativeThreshold { min: 60, max: 79, description: "体力尚可，虽有些疲惫".to_string() },
                    NarrativeThreshold { min: 40, max: 59, description: "体力有些不支".to_string() },
                    NarrativeThreshold { min: 20, max: 39, description: "精疲力竭".to_string() },
                    NarrativeThreshold { min: 0, max: 19, description: "体力耗尽".to_string() },
                ],
                note: None,
            },
        );
