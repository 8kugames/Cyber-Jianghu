...
pub struct AgentStateRulesData {
    /// 衰减配置
    pub decay: DecayRulesData,

    /// 状态限制配置
    pub limits: StateLimitsRulesData,
...
/// 衰减规则数据
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct DecayRulesData {
    #[serde(rename = "sanity_per_tick")]
    pub sanity_per_tick: i32,
    #[serde(rename = "hunger_per_tick")]
    pub hunger_per_tick: i32,
    #[serde(rename = "thirst_per_tick")]
    pub thirst_per_tick: i32,
    #[serde(rename = "stamina_recovery")]
    pub stamina_recovery: i32,
    #[serde(rename = "stamina_after_action")]
    pub stamina_after_action: i32,
    #[serde(default = "default_idle_bonus")]
    pub idle_bonus: i32,
}

/// 状态限制规则数据
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct StateLimitsRulesData {
    #[serde(default = "default_hp_min")]
    pub hp_min: i32,
    pub hp_max: i32,
    #[serde(default = "default_stamina_min")]
    pub stamina_min: i32,
    pub stamina_max: i32,
    #[serde(default = "default_hunger_min")]
    pub hunger_min: i32,
    pub hunger_max: i32,
    #[serde(default = "default_thirst_min")]
    pub thirst_min: i32,
    pub thirst_max: i32,
...
fn default_idle_bonus() -> i32 { 0 }
fn default_hp_min() -> i32 { 0 }
fn default_stamina_min() -> i32 { 0 }
fn default_hunger_min() -> i32 { 0 }
fn default_thirst_min() -> i32 { 0 }
fn default_sanity_min() -> i32 { 0 }
fn default_reputation_min() -> i32 { -1000 }
fn default_max_agent_name_length() -> usize { 100 }
fn default_max_system_prompt_length() -> usize { 102400 }
fn default_max_speak_content_length() -> usize { 500 }
fn default_dialogue_window() -> u64 { 30 }
fn default_max_messages() -> u32 { 10 }
...
/// 动作配置数据
pub type ActionsData = std::collections::HashMap<String, crate::game_data::types::ActionConfigEntry>;
...
/// 统一初始背包配置
pub type UnifiedInitialInventoryConfig = UnifiedConfig<Vec<super::inventory::InitialInventoryItem>>;
