    ...
    TEST_REGISTRY.get_or_init(|| {
        ...
        fs::write(
            ...
            r#"{
                ...
                "data": {
                    "agent_state": {
                        "decay": { "sanity_per_tick": 0, "hunger_per_tick": -5, "thirst_per_tick": -5, "stamina_recovery": 5, "stamina_after_action": 2, "idle_bonus": 5 },
                        "limits": { "hp_min": 0, "hp_max": 100, "stamina_min": 0, "stamina_max": 100, "hunger_min": 0, "hunger_max": 100, "thirst_min": 0, "thirst_max": 100, "sanity_min": 0, "sanity_max": 100, "reputation_min": -1000, "reputation_max": 1000 },
                ...
                "data": {
                    ...
                    "status": {
                        ...
                        "attributes": {
                            ...
                            "stamina": { "name": "stamina", "display_name": "体力", "description": "体力", "type": "status", "default_value": 100, "min_value": 0, "max_value_formula": "100", "decay_per_tick": -5 },
