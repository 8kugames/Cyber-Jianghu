                ...
                "data": {
                    ...
                    "status": {
                        ...
                        "attributes": {
                            ...
                            "hunger": { "name": "hunger", "display_name": "饥饿", "description": "饥饿", "type": "status", "default_value": 50, "min_value": 0, "max_value_formula": "100", "decay_per_tick": 5, "death_condition": { "operator": "equals", "value": 0 }, "death_cause": "hunger", "death_message": "你因长期饥饿而倒下，意识逐渐模糊..." },
                            "thirst": { "name": "thirst", "display_name": "口渴", "description": "口渴", "type": "status", "default_value": 50, "min_value": 0, "max_value_formula": "100", "decay_per_tick": 5, "death_condition": { "operator": "equals", "value": 0 }, "death_cause": "thirst", "death_message": "你因严重脱水而倒下，眼前一片黑暗..." },
