...
use super::super::{MoveData, PickupData, SpeakData, DropData, GatherData, CraftData};
...
impl BasicActionExecutor {
    ...
    pub(super) fn execute_gather(
        ...
        // 季节影响产量
        let mut quantity = 1;
        if let Some(season) = crate::game_data::registry::TimeRegistry::get_current_season(intent.tick_id) {
