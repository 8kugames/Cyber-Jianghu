-- ============================================================================
-- Ground Items and Additional Mechanics
-- ============================================================================
...
COMMENT ON COLUMN ground_items.dropped_by IS '掉落者（可选）';

-- 更新 Schema 版本
INSERT INTO schema_version (version, description) VALUES (3, 'Add ground items');
