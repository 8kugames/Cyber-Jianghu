    ...
    pub fn parse_from_prompt(_prompt: &str, agent_name: &str) -> HashMap<String, Trait> {
        ...
        match agent_name {
            "柳云娘" => {
                traits.insert(
                    "贪婪".to_string(),
                    Trait::new("贪婪".to_string(), TraitType::Moral, 70),
                );
                traits.insert(
                    "信誉".to_string(),
                    Trait::new("信誉".to_string(), TraitType::Moral, 80),
                );
                traits.insert(
                    "精明".to_string(),
                    Trait::new("精明".to_string(), TraitType::Capability, 85),
                );
                traits.insert(
                    "同情心".to_string(),
                    Trait::new("同情心".to_string(), TraitType::Moral, 50),
                );
                traits.insert(
                    "求生欲".to_string(),
                    Trait::new("求生欲".to_string(), TraitType::Survival, 75),
                );
            }
            "燕无归" => {
                traits.insert(
                    "沉默".to_string(),
                    Trait::new("沉默".to_string(), TraitType::Social, 90),
                );
                traits.insert(
                    "复仇心".to_string(),
                    Trait::new("复仇心".to_string(), TraitType::Survival, 95),
                );
                traits.insert(
                    "孤独".to_string(),
                    Trait::new("孤独".to_string(), TraitType::Social, 80),
                );
                traits.insert(
                    "正义感".to_string(),
                    Trait::new("正义感".to_string(), TraitType::Moral, 60),
                );
                traits.insert(
                    "求生欲".to_string(),
                    Trait::new("求生欲".to_string(), TraitType::Survival, 90),
                );
            }
            "方子清" => {
                traits.insert(
                    "迂腐".to_string(),
                    Trait::new("迂腐".to_string(), TraitType::Capability, 70),
                );
                traits.insert(
                    "书卷气".to_string(),
                    Trait::new("书卷气".to_string(), TraitType::Capability, 80),
                );
                traits.insert(
                    "善良".to_string(),
                    Trait::new("善良".to_string(), TraitType::Moral, 75),
                );
                traits.insert(
                    "天真".to_string(),
                    Trait::new("天真".to_string(), TraitType::Social, 60),
                );
                traits.insert(
                    "求知欲".to_string(),
                    Trait::new("求知欲".to_string(), TraitType::Capability, 70),
                );
            }
            "小翠" => {
                traits.insert(
                    "机灵".to_string(),
                    Trait::new("机灵".to_string(), TraitType::Capability, 85),
                );
                traits.insert(
                    "谨慎".to_string(),
                    Trait::new("谨慎".to_string(), TraitType::Social, 80),
                );
                traits.insert(
                    "戒备".to_string(),
                    Trait::new("戒备".to_string(), TraitType::Emotional, 75),
                );
                traits.insert(
                    "嘴甜".to_string(),
                    Trait::new("嘴甜".to_string(), TraitType::Social, 70),
                );
                traits.insert(
                    "求生欲".to_string(),
                    Trait::new("求生欲".to_string(), TraitType::Survival, 85),
                );
            }
            "钱三通" => {
                traits.insert(
                    "贪婪".to_string(),
                    Trait::new("贪婪".to_string(), TraitType::Moral, 90),
                );
                traits.insert(
                    "圆滑".to_string(),
                    Trait::new("圆滑".to_string(), TraitType::Social, 85),
                );
                traits.insert(
                    "中立".to_string(),
                    Trait::new("中立".to_string(), TraitType::Moral, 70),
                );
                traits.insert(
                    "精明".to_string(),
                    Trait::new("精明".to_string(), TraitType::Capability, 80),
                );
                traits.insert(
                    "求生欲".to_string(),
