...
impl OpenClawLLMClient {
    ...
    fn chat_completions_url(&self) -> String {
        format!("{}/v1/chat/completions", self.gateway_url.trim_end_matches('/'))
    }

    /// 执行 HTTP POST 请求
    async fn post_chat_completion(&self, request: ChatCompletionRequest) -> Result<ChatCompletionResponse> {
