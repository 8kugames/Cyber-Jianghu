...
use crate::ai::relationship::types::{KeyEvent, RelationshipMemory};
...
impl RelationshipStore {
    ...
    pub fn get_relationship(&self, target_agent_id: Uuid) -> Result<Option<RelationshipMemory>> {
        ...
        let (target_name, favorability, last_interaction_tick, updated_at_str, self_description, description_tick) =
